      ...
      <main className="page-main supporting-page">
        <div className="page-content">
          ...
          <section className="prose-block">
            ...
            <p>If you need to cover payroll, inventory, equipment, or a short-term gap, understanding what’s available can help. Not all applicants qualify; terms vary. <a href={FIND_MATCH_URL} target="_blank" rel={AXIANT_LINK_REL}>See What Restaurant Funding Options May Be Available</a>.</p>
          </section>
        </div>
      </main>
      <CTA />
