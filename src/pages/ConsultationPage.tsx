...
import { CONSULTATION_BOOKING_URL, AXIANT_LINK_REL, PHONE_HREF, PHONE_NUMBER } from '../config';
...
function ConsultationForm() {
    ...
    return (
      <div className="lead-form lead-form--success" role="status">
        <p className="lead-form__success-text">
          We got your message. Someone will call you at the number you provided within 1 business day — often same day.
        </p>
      </div>
    );
  }
  ...
  return (
    <form className="lead-form" action={FORMSPREE_ACTION} method="POST" onSubmit={handleSubmit}>
      <input type="hidden" name="_source" value="restaurantownersguide-consultation" />
      ...
      <div className="lead-form__field">
        ...
        <textarea
          ...
          placeholder="Example: Payroll is due Friday and I'm $8,000 short. Or: My walk-in broke last night and I need $15,000 for repairs."
        />
      </div>
        ...
        <div className="page-content">
          <section className="consultation-section consultation-section--with-form">
            ...
            <p className="consultation-section__alt">
              ...
              <a href={PHONE_HREF} className="consultation-section__alt-link">
                {PHONE_NUMBER}
              </a>
            </p>
            <p className="consultation-section__alt">
            ...
            <p className="consultation-section__sub">
              You can also explore our guides below before or after you reach out.
            </p>
            <div className="consultation-section__links">
              <p>Before or after your call, explore our guides:</p>
              <ul>
                <li>
                  <Link to="/restaurant-cash-flow-guide">Restaurant Cash Flow Guide</Link>
                </li>
                <li>
                  <Link to="/restaurant-funding-options">Restaurant Funding Options</Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/restaurant-funding">Restaurant Funding</Link>
                </li>
              </ul>
            </div>
          </section>
