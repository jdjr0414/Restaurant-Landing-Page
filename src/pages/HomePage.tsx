...
const KITCHEN_IMAGE = 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=1920&q=95';
const EQUIPMENT_IMAGE = 'https://images.unsplash.com/photo-1577219491135-ce391730fb2c?w=1920&q=95';
      ...
      <main className="home-page">
        ...
        <div className="page-content home-content">
          ...
          <section className="home-section">
            ...
            <p className="home-section__p">
              Understanding what&apos;s going on is the first step. The <Link to="/restaurant-cash-flow-problems">restaurant cash flow problems</Link> guide explains why restaurants run out of cash in depth. The <Link to="/restaurant-cash-flow-guide">restaurant cash flow guide</Link> covers the timing mismatch and what to do about it. This site helps you make sense of <strong>restaurant cash flow problems</strong>, learn what <strong>restaurant funding</strong> and working capital mean, and see what options might fit your situation—so you can stop guessing and take a clear next step. Compare <Link to="/restaurant-funding-options">restaurant funding options</Link> when you&apos;re ready. If you run a food truck, bar, or pizzeria, see <Link to="/restaurant-funding-by-business-type">restaurant funding by business type</Link>; for state-specific info, <Link to="/restaurant-funding-by-state">restaurant funding by state</Link>.
            </p>
          </section>
