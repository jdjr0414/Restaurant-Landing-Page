      ...
      <main className="page-main supporting-page">
        <div className="page-content">
          ...
          <section className="prose-block">
            ...
            <p>
              The first restaurant funds the opening of the second: deposits, build-out, equipment, and initial labor for the new site often come from the original location’s profits. Until the second unit is generating positive cash flow, you are running two operations on the cash flow of one. If the first location has a slow quarter or an unexpected expense, you may not have a cushion—and both locations can suffer. The <Link to="/restaurant-cash-flow-guide">restaurant cash flow guide</Link> and <Link to="/restaurant-cash-flow-guide">profitable on paper but no cash</Link> explain how timing and reinvestment affect cash; here we focus on expansion specifically.
            </p>
            <p>
