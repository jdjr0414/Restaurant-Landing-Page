/**
 * Pillar page paths only (no content). Keep in sync with pillarPages.tsx pillarPagesConfig.
 * Used by App.tsx for <Route> definitions without importing the heavy pillar content module.
 */
export const PILLAR_ROUTE_PATHS: string[] = [
